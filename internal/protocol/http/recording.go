...
// socks5Scheme returns the scheme string unchanged regardless of SOCKS5 context.
// SOCKS5 is a transport layer that does not affect the URL scheme.
func socks5Scheme(ctx context.Context, base string) string {
	return base
}
