...
If the user declines review, skip 4-2 through 4-5 entirely (and skip the Read of `review-context.md` / agent templates — they are lazy-loaded).

### 4-2. Build Review Context (lazy)

Only when the user opts into review:
